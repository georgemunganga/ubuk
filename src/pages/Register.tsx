      ...
      <div className="relative md:w-1/2 h-48 sm:h-64 md:h-auto md:min-h-screen overflow-hidden animate-slide-in-left">
        ...
        <div className="absolute bottom-8 left-8 md:bottom-16 md:left-16 text-white max-w-md animate-fade-in animate-stagger-1">
          ...
          <p className="text-white/90 text-lg md:text-xl leading-relaxed">
            Join thousands of users finding trusted professionals every day.
          </p>
        </div>
      </div>

      {/* Right Side - Register Form */}
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 bg-white animate-slide-in-right overflow-y-auto min-h-screen md:min-h-0">
        <div className="w-full max-w-md space-y-4 md:space-y-6 py-8 px-6 md:px-8 border-2 border-primary rounded-3xl shadow-lg">
          {/* Logo */}
          ...
          {/* Register Form */}
          <form className="space-y-5 animate-fade-in animate-stagger-2">
            {/* Full Name */}
